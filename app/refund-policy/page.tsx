...
import { Receipt, RefreshCcw, CreditCard, CheckCircle2, ArrowLeft } from "lucide-react";
  ...
  useEffect(() => {
    async function fetchConfig() {
      try {
        ...
        setContent(normalized.legal.refundPolicy);
      } catch (error) {
    ...
    <main className="min-h-screen bg-[#FDFCFB]">
      ...
      <div className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full max-w-7xl pointer-events-none">
          <div className="absolute top-[20%] right-[-15%] w-[50%] h-[50%] bg-primary/5 rounded-full blur-[140px]" />
          <div className="absolute top-[-10%] left-[-10%] w-[35%] h-[35%] bg-primary/10 rounded-full blur-[100px]" />
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          ...
          <div className="mb-16">
            ...
            >
              Refund <em className="gold-text not-italic">Policy</em>
            </motion.h1>
            ...
            >
              Our goal is your complete satisfaction. Learn about our flexible cancellation and refund terms for all our adventures.
            </motion.p>
          </div>
              ...
              {!loading && (
                <div className="mt-16 pt-12 border-t border-primary/10 grid grid-cols-1 sm:grid-cols-3 gap-8">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm font-medium text-text-dark">Easy Returns</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-primary/5 flex items-center justify-center text-primary">
                      <CreditCard className="w-5 h-5" />
                    </div>
                    <span className="text-sm font-medium text-text-dark">Direct Payouts</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-primary/5 flex items-center justify-center text-primary">
                      <CheckCircle2 className="w-5 h-5" />
                    </div>
                    <span className="text-sm font-medium text-text-dark">No Hidden Fees</span>
                  </div>
                </div>
              )}
            </div>
