  ...
  useEffect(() => {
    async function fetchConfig() {
      try {
        ...
        setContent(normalized.legal.termsOfService);
      } catch (error) {
      ...
      <div className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          ...
          <div className="mb-16">
            ...
            >
              Please review the rules and guidelines for using our services. We aim for transparency and excellence in every adventure.
            </motion.p>
          </div>
              ...
              {!loading && (
                <div className="mt-16 pt-12 border-t border-primary/10 grid grid-cols-1 sm:grid-cols-3 gap-8">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm font-medium text-text-dark">Fair Agreement</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-primary/5 flex items-center justify-center text-primary">
                      <Gavel className="w-5 h-5" />
                    </div>
                    <span className="text-sm font-medium text-text-dark">Legal Compliance</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-primary/5 flex items-center justify-center text-primary">
                      <CheckCircle2 className="w-5 h-5" />
                    </div>
                    <span className="text-sm font-medium text-text-dark">Updated 2024</span>
                  </div>
                </div>
              )}
            </div>
